...
- [x] Refactor all JS modules for readability and documentation.
...
- [x] Refactor and document all JS modules (trust, hero, stats, services, about, cta, loader, nav, scroll, dots).
...
- [x] Performance optimization of primary assets.
- [x] JS readability and maintainability refactor.
